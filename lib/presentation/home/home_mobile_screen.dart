...
import 'package:selorg/model/category/dynamic_category_model.dart';
import 'package:selorg/model/category/dynamic_category_model.dart'
    as dynamiccatmodel;
import 'package:selorg/model/home/dynamic_product_style_response_model.dart';
import 'package:selorg/presentation/category/category_bloc.dart';
import 'package:selorg/presentation/category/category_event.dart';
import 'package:selorg/presentation/category/category_state.dart';
import 'package:selorg/presentation/home/cart_increment_cubit.dart';
import 'package:selorg/presentation/home/home_bloc.dart';
import 'package:selorg/presentation/home/home_event.dart';
import 'package:selorg/presentation/home/home_state.dart';
import 'package:selorg/presentation/location/location_screen.dart';
import 'package:selorg/model/category/category_model.dart' as catmodel;
import 'package:selorg/model/category/main_category_model.dart';
import 'package:selorg/model/category/product_style_model.dart';
import 'package:selorg/model/home/banner_model.dart';
import 'package:selorg/model/home/grab_essentials_model.dart';
import 'package:selorg/presentation/banner/banner_screen.dart';
import 'package:selorg/presentation/productdetails/product_details_screen.dart';
import 'package:selorg/presentation/productlist/product_list_menu.dart';
import 'package:selorg/presentation/search/search_screen.dart';
...
class HomeMobileScreen extends StatelessWidget {
  ...
  void showLocationBottomSheet(BuildContext context, String latitude,
      String longitude, String place, HomeBloc homebloc) {
            ...
            children: [
              ...
              Column(
                ...
                children: [
                  ...
                  Text("for better delivery experience",
                      style: TextStyle(
                        color: greyColor,
                      )),
                ],
      ...
      child: BlocConsumer<HomeBloc, HomeState>(
        listener: (context, state) {
          if (state is GrabandEssentialsLoadedState) {
            ...
            showLocationBottomSheet(context, state.latitude ?? "",
                state.longitude ?? "", state.place!, context.read<HomeBloc>());
            ...
            if (state.type == "screen") {
              ...
              context.read<HomeBloc>().add(AddItemInCartApiEvent(
                    userId: userId,
                    productId: state.response.id ?? "",
                    quantity: 1,
                    variantLabel: selectedProductIndexes ==
                    ...
                    price: selectedProductIndexes == state.selectedIndexes
                        ? state.response.variants![productVarientIndex].price ??
                            0
                        : state.response.variants![0].price ?? 0,
                    discountPrice:
                        selectedProductIndexes == state.selectedIndexes
                            ? state.response.variants![productVarientIndex]
                                    .discountPrice ??
                                0
              ...
              state.response.variants![state.selectedIndexes].cartQuantity =
                  (state.response.variants![state.selectedIndexes]
                              .cartQuantity ??
                          0) +
                      1;
            }
            ...
            context
                .read<HomeBloc>()
                .add(GetScreenEvent(cartcount: state.noOfItems, index: 0));
            ...
            if (state.type == "screen") {
              state.response.variants![0].cartQuantity == 0
                  ...
                  : state.response.variants![0].cartQuantity =
                      (state.response.variants![0].cartQuantity ?? 0) - 1;
              context.read<HomeBloc>().add(RemoveItemInCartApiEvent(
                  userId: userId,
                  productId: state.response.id ?? "",
        ...
        builder: (context, state) {
          if (state is HomeInitialState) {
            ...
            context.read<HomeBloc>().add(GetOrganicFruitsEvent(
                mainCatId: "676431a2edae32578ae6d220",
                subCatId: "676ad87c756fa03a5d0d0616",
                mobileNo: phoneNumber));
            context.read<HomeBloc>().add(GetGroceryEssentialsEvent(
                subCatId: "676b624a84dd76eac5d33a3e", mobileNo: phoneNumber));
            context.read<HomeBloc>().add(GetNutsDriedFruitsEvent(
                subCatId: "676b62c484dd76eac5d33a46", mobileNo: phoneNumber));
            context.read<HomeBloc>().add(GetRiceCerealsEvent(
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text("Grab & Go essentials for you!",
                                        ...
                                        Expanded(
                                          child: InkWell(
                                            onTap: () {
                                              ...
                                              mainCatId = grabandEssential
                                                      .data![i].id ??
                                                  "";
                                              isCategory = true;
                                              catId = grabandEssential
                                                      .data![i].id ??
                                                  "";
                                              Navigator.push(
                                                  context,
                                      ...
                                      child: Container(
                                        ...
                                        child: ClipRRect(
                                          borderRadius:
                                              BorderRadius.circular(8),
                                          child: ImageNetwork(
                                            url: dailybanners[index].imageUrl ??
                                                "",
                                            fit: BoxFit.cover,
                                          ),
                                        ),
                            ...
                            if (dynamicProducts.data != null)
                              Column(
                                children:
                                    dynamicProducts.data!.map((productdata) {
                                                                    ...
                                                                    product[i].variants![0].cartQuantity ==
                                                                        ...
                                                                        ? Expanded(
                                                                            child:
                                                                                InkWell(
                                                                              onTap: () {
                                                                                context.read<HomeBloc>().add(AddButtonClikedEvent(response: product[i], type: "screen", index: i, isButtonPressed: true));
                                                                              },
                                                                              child: Container(
                                                                                height: 30,
                                                                                decoration: BoxDecoration(border: Border.all(color: appColor), borderRadius: BorderRadius.circular(20)),
                                                                                child: Center(
                                                                                  child: Text(
                                                                                    'Add',
                                                                                    style: TextStyle(
                                                                        ...
                                                                        : Expanded(
                                                                            child:
                                                                                Container(
                                                                              height: 30,
                                                                              decoration: BoxDecoration(color: appColor, border: Border.all(color: appColor), borderRadius: BorderRadius.circular(20)),
                                                                              child: Row(
                                                                                mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                                                                                children: [
                                                                                  InkWell(
                                                                                    onTap: () {
                                                                                      context.read<HomeBloc>().add(RemoveItemButtonClikedEvent(response: product[i], type: "screen", index: i, isButtonPressed: true));
                                                                                    },
