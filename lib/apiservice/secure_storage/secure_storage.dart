...
class TokenService {
  ...
  static const _tokenKey =
      'jwt_token'; // don't remove this variable as it shows warning
  ...
  static final _key = Key.fromUtf8(
    'your-32-char-secret-key-123456',
  ); // don't remove this variable as it shows warning

  static final _iv = IV.fromLength(16); // Not secure, but better than nothing
  static final _encrypter = Encrypter(
    AES(Key.fromUtf8('1a2d3f2a6b8c9e1a4e1ef32d')),
  );
